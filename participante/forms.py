...
class cadastro_dados_participante(ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'ctps_serie' : forms.TextInput(attrs={'type': 'text', 'class': 'form-control', 'placeholder': 'Série da ctps'}),
            ...
            'verificacao_nis' : forms.TextInput(attrs={'type': 'text', 'class': 'form-control', 'placeholder': 'NIS'}),
            'verificacao_contrato_trabalho' : forms.TextInput(attrs={'type': 'text', 'class': 'form-control', 'placeholder': 'Contrato de trabalho'}),
            'verificacao_ctps' : forms.TextInput(attrs={'type': 'text', 'class': 'form-control', 'placeholder': 'CTPS'}),
            'verificacao_cpf' : forms.TextInput(attrs={'type': 'text', 'class': 'form-control', 'placeholder': 'CPF'}),
            'verificacao_rg' : forms.TextInput(attrs={'type': 'text', 'class': 'form-control', 'placeholder': 'RG'}),
            'verificacao_endereco' : forms.TextInput(attrs={'type': 'text', 'class': 'form-control', 'placeholder': 'Endereço'}),
            ...
            'tipo_documento_empregador': forms.Select(attrs={'type': 'select', 'class': 'form-control', 'placeholder': 'Tipo de numeração', 'required': True}),
